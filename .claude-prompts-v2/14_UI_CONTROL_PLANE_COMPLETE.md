# Fase 14 - UI completa del Control Plane
...
Consolidar UX después de tener el dominio, evitando pantallas técnicas inconexas.

## Navegación propuesta

### Plataforma
- Dashboard
- Suite SaaS / Productos
...
- Implementaciones / Addons

### Cobranza
- Facturación y Cobros
- Métodos de cobro / Collection Profiles
- OS / OC
...
- Mantén tema/tokens EBIM existentes.
- Tablas con buscador único + tabs de estado; evita filtros caóticos.
- Detail pages con breadcrumbs y tabs.
- Acciones peligrosas con ConfirmDialog.
- Formularios con validación inline.
- No mostrar botones no autorizados, pero seguridad real permanece en DB.
- Responsive suficiente para laptop/tablet; no priorizar móvil extremo.
- Estados Loading/Error/Empty consistentes.

## Vista 360 clave

Crear una vista de Organization/Customer donde gerencia vea en una sola pantalla:
- capacidades (cliente/partner/reseller);
- productos contratados;
- tenants;
- deployment mode;
- licencias;
- método de cobro por SaaS;
- próxima renovación;
- OS/OC;
- cobros;
- comercial y comisión;
- margen aproximado;
- provisioning/deployment.

Esta vista debe ser la demostración principal del Control Plane.
