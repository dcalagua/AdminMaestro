...
Última actualización: fase 04. Solo se marca PASS con salida de comando ejecutada en la fase indicada.
...
| E2E | PARCIAL (fase 04) | `v2-journeys` J1, J2 y J10–J14 PASS (10 tests, filtro `-g "J2|J1"`, 2.ª ejecución; la 1.ª tras `db reset` falló por arranque en frío de la sesión). Suite completa pendiente de fase 17 |
