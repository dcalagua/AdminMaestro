...
Última actualización: fase 06. Solo se marca PASS con salida de comando ejecutada en la fase indicada.

| Gate | Result | Evidence |
|---|---|---|
| db reset | PASS (fase 06) | 27 migraciones + seed |
| pgTAP | PASS (fase 06) | 10 ficheros, 209/209 |
| unit | PASS (fase 06) | 5 ficheros, 66/66 |
| typecheck | PASS (fase 06) | tras `db:types`; `deno check` del adapter de pagos OK |
| lint | PASS (fase 06) | `eslint .` exit 0 |
| build | NOT_RUN | |
